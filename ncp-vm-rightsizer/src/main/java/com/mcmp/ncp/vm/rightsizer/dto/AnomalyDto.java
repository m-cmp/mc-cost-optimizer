...
public class AnomalyDto {
    ...
    @Builder
    public AnomalyDto(LocalDateTime collectDt, String memberNo, String vmId, String productCd, String abnormalRating, double percentagePoint, double standardCost, double subjectCost, String projectCd, String workspaceCd, String cspType) {
