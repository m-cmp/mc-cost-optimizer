...
import com.mcmp.cost.azure.collector.service.BudgetCheckService;
...
public class AdminBudgetController {
    ...
    public ResponseEntity<String> checkBudget() {
        try {
            ...
            return ResponseEntity.ok("Azure Budget Check triggered successfully");
        } catch (Exception e) {
            log.error("Azure Budget Check 실행 실패", e);
