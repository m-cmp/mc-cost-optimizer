package com.mcmp.azure.vm.rightsizer.utils;
...
public class AzureUtils {
    ...
    public static ClientSecretCredential buildCredential(AzureCredentialProperties azureCredentialProperties) {
        return new ClientSecretCredentialBuilder()
                .tenantId(azureCredentialProperties.getTenantId())
                .clientId(azureCredentialProperties.getClientId())
                .clientSecret(azureCredentialProperties.getClientSecret())
                .build();
    }

    public static AzureProfile buildProfile(AzureCredentialProperties azureCredentialProperties) {
        return new AzureProfile(azureCredentialProperties.getTenantId(),
