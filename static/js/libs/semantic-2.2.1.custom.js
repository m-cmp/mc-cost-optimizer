              ...
              .find('option')
                .each(function() {
                  var
                    ...
                    dataIcon = ( $option.attr('data-icon') !== undefined )
        ...
        add: {
          ...
          variables: function(message, term) {
            ...
            if(hasCount) {
              ...
              message = message.replace('{placeholder}', module.get.placeholderText()).replace('{count}', count).replace('{totalCount}', module.get.totalCount());
            }
            if(hasMaxCount) {
              count  = module.get.selectionCount();
...
$.fn.dropdown.settings = {
  ...
  message: {
    ...
    count         : '{placeholder} {count}/{totalCount}',
...
$.fn.dropdown.settings.templates = {
  ...
  dropdown: function(select) {
    ...
    $.each(select.values, function(index, option) {
      var name = option.dataIcon !== "" ? '<span data-icon="' + option.dataIcon + '">' + option.name + '</span>' : option.name;
      html += (option.disabled)
        ? '<div class="disabled item" data-value="' + option.value + '">' + name + '</div>'
        : '<div class="item" data-value="' + option.value + '">' + name + '</div>'
      ;
    });
    html += '</div>';
    return html;
