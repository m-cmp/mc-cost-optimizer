package com.mcmp.assetcollector.config;
...
public class DatabaseConfig {
    ...
    public SqlSessionFactory sqlSessionSimple() throws Exception {
        SqlSessionFactoryBean sqlSession = new SqlSessionFactoryBean();
        sqlSession.setDataSource(dataSourceBatch());
        sqlSession.setMapperLocations(new PathMatchingResourcePatternResolver().getResources(ResourcePatternResolver.CLASSPATH_URL_PREFIX + "/mapper/simple/*_SQL.xml"));
        return sqlSession.getObject();
    }
