    ...
    <div class="container-xl">
        <div class="row g-2 align-items-center">
            ...
            <div class="selectBoxList">
                <!-- selectBox 1 -->
                <div class="box">
                    <div class="selectBox2" @click="toggleOptions('workspace')">
                ...
                <!-- selectBox 2 -->
                <div class="box">
                    <div class="selectBox2" @click="toggleOptions('project')">
                ...
                <!-- selectBox 3 -->
                <div class="box">
                    <div class="selectBox2" @click="toggleOptions('csp')">
...
export default {
    ...
    methods: {
        toggleOptions(type) {
            this.resetOptions();
            if (type === 'workspace') this.showWorkspaceOptions = !this.showWorkspaceOptions;
            if (type === 'project') this.showProjectOptions = !this.showProjectOptions;
            if (type === 'csp') this.showCSPOptions = !this.showCSPOptions;
        },
        resetOptions() {
...
.selectBox2 .optionList[v-show="true"] {
    display: block;
}
