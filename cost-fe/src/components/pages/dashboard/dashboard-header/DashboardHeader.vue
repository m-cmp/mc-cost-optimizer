...
<header class="navbar navbar-expand-md d-print-none">
    <div class="container-xl">
        ...
        <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
            <a href=".">
                <img src="@/assets/images/mcmp-logo.png" width="110" height="32" alt="Tabler" class="navbar-brand-image">
            </a>
        </h1>
        <div class="navbar-nav flex-row order-md-last">
            <div class="nav-item d-none d-md-flex me-3">
                <!-- Source code, Sponsor button delete -->
            </div>
                ...
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                        ...
                        <div class="d-none d-xl-block ps-2">
                            <div>JJ</div>
                            <div class="mt-1 small text-muted">Slave</div>
                        </div>
                    </a>
...
export default {
    ...
    data() {
        return {
            avatarUrl: require('@/assets/images/avatars/000m.jpg'),
        };
    },
    methods: {
        enableDarkMode() {
